...
OpenWorldScene::OpenWorldScene(std::shared_ptr<Window> t_window, int width, int height) : Scene(t_window, width, height) {
    ...
    /* LIGHTS */
    std::shared_ptr<PointLight> sunLight = std::make_shared<PointLight>(glm::vec3(100.0f, 10.0f, 0.0f), glm::vec3(0.8f, 0.8f, 0.75f));
    ...
    std::shared_ptr<PointLight> pureWhiteLight = std::make_shared<PointLight>(glm::vec3(0.0f, 200.0f, 0.0f), glm::vec3(0.8f, 0.8f, 0.8f));
    std::shared_ptr<PointLight> redLight = std::make_shared<PointLight>(glm::vec3(0.0f, 0.0f, 20.0f), glm::vec3(0.8f, 0.0f, 0.0f));
    std::shared_ptr<DirLight> dirLight = std::make_shared<DirLight>(glm::vec3(0.0f, 0.0f, 20.0f), glm::vec3(0.8f, 0.8f, 0.8f), glm::vec3(-0.2f, -1.0f, -0.3f));
    ...
    this->treesShader = std::make_shared<Shader>("textured_light.vsh", "textured_light.fsh", camera, lights, false);
    ...
    this->treeModel = std::make_shared<Model>("trees/tree/tree.obj");

    /* TEXTURES */
    std::shared_ptr<Texture> houseTexture = std::make_shared<Texture>(false, "textures/house.png");
    std::shared_ptr<Texture> skyTexture = std::make_shared<Texture>(true, "textures/nicer_skybox/");
    ...
    this->treeTexture = std::make_shared<Texture>(false, "textures/tree.png");
